          ...
          <div className="flex flex-col items-left border border-gray-300 rounded-3xl bg-white">
            ...
            <div className="flex justify-between items-center space-x-2 mt-4 mx-4">
              ...
              <button
                ...
                className="w-1/2 bg-white text-black font-semibold items-center border border-gray-300 px-[calc(1rem-2px)] py-[calc(0.5rem-2px)] rounded-full hover:bg-gray-200 hover:text-black text-sm"
              >
                Withdraw
              </button>
            </div>
